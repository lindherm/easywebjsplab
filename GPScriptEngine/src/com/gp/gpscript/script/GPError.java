 ...
 *
 * <p>Title: GPError</p>
 * <p>Description: This is used to display the error infomation when GP  encounter an exception</p>
...
/*      ScriptableObject.putProperty(obj, "name", "GPError");
      ScriptableObject.putProperty(obj, "message", "");
      ScriptableObject.putProperty(obj, "className", "");
      ScriptableObject.putProperty(obj, "error", new Integer(0) );
      ScriptableObject.putProperty(obj, "reason", new Integer(0) );
*/      obj.exportAsJSClass(MAX_PROTOTYPE_ID, scope, sealed);
  ...
  {
    if (id == Id_className) { return "className"; }
    if (id == Id_error) { return "error"; }
    if (id == Id_message) { return "message"; }
    if (id == Id_name) { return "name"; }
    if (id == Id_reason) { return "reason"; }
  ...
  protected void fillConstructorProperties(IdFunctionObject ctor)
  {
      ...
      ctor.defineProperty("KEY_NOT_FOUND",
                          ScriptRuntime.wrapNumber(KEY_NOT_FOUND),
                          attr);
      ctor.defineProperty("DEVICE_ERROR",
                          ScriptRuntime.wrapNumber(DEVICE_ERROR),
                          attr);
      ctor.defineProperty("INVALID_DATA",
                          ScriptRuntime.wrapNumber(INVALID_DATA),
                          attr);
      ctor.defineProperty("INVALID_MECH",
                          ScriptRuntime.wrapNumber(INVALID_MECH),
                          attr);
      ctor.defineProperty("INVALID_KEY",
                          ScriptRuntime.wrapNumber(INVALID_KEY),
                          attr);
      ctor.defineProperty("INVALID_TYPE",
                          ScriptRuntime.wrapNumber(INVALID_TYPE),
                          attr);
      ctor.defineProperty("INVALID_USAGE",
                          ScriptRuntime.wrapNumber(INVALID_USAGE),
                          attr);
      ctor.defineProperty("USER_DEFINED",
                          ScriptRuntime.wrapNumber(USER_DEFINED),
                          attr);
      ctor.defineProperty("UNDEFINED",
                          ScriptRuntime.wrapNumber(UNDEFINED),
                          attr);
      ctor.defineProperty("UNSUPPORTED",
                          ScriptRuntime.wrapNumber(UNSUPPORTED),
                          attr);
      ctor.defineProperty("OBJECTCREATIONFAILED",
                          ScriptRuntime.wrapNumber(OBJECTCREATIONFAILED),
                          attr);

      super.fillConstructorProperties(ctor);
  }

  static GPError js_construct(Context cx, Scriptable scope,
