...
/**
 *
 * <p>Title: ByteString</p>
 * <p>Description:
 * This class implements the ByteString (a native object).
 * See [GP_SYS_SCR] 7.2. 3 </p>
...
public class NativeByteString extends IdScriptableObject
{
     ...
     * @param encoding (HEX/ASCII/BASE64/UTF8/CN)
     */
        ...
        (IdFunctionObject ctor)
    {
       ...
       ctor.defineProperty("XOR",
                            ScriptRuntime.wrapNumber(XOR),
                            attr);

       addIdFunctionProperty(ctor, BYTESTRING_TAG, ConstructorId_fromCharCode,
                              "fromCharCode", 1);
    ...
    protected void initPrototypeId(int id)
    {
        ...
        switch (id) {
                ...
                case Id_and:	  arity = 1; s ="and"; break;
                case Id_bytes:	  arity = 2; s ="bytes"; break;
                case Id_concat:	  arity = 1; s = "concat"; break;
                case Id_crc:	  arity = 1; s = "crc"; break;
                case Id_equals:	  arity = 1; s = "equals"; break;
                case Id_find:	  arity = 2; s = "find"; break;
                case Id_getL:	  arity = 1; s = "getL"; break;
                case Id_getLV:	  arity = 1; s = "getLV"; break;
                case Id_left:	  arity = 1; s = "left"; break;
                case Id_neg:	  arity = 1; s = "neg"; break;
                case Id_not:	  arity = 0; s = "not"; break;
                case Id_or:	  arity = 1; s = "or"; break;
                case Id_pad:	  arity = 2; s = "pad"; break;
                case Id_right:	  arity = 1; s = "right"; break;
                case Id_startsWith:arity = 1; s = "startsWith"; break;
                case Id_toBase64: arity = 1; s = "toBase64"; break;
                case Id_toBcd:	  arity = 1; s = "toBcd"; break;
                case Id_toHex:	  arity = 1; s = "toHex"; break;
                case Id_toSigned: arity = 1; s = "toSigned"; break;
                case Id_toUnsigned:arity = 1; s = "toUnsigned"; break;
                case Id_xor:	   arity = 1; s = "xor"; break;
                case Id_hex2String:	   arity = 1; s = "hex2String"; break;
                case Id_deleteEightZero:	   arity = 1; s = "deleteEightZero"; break;
...
/*        Object temp;
        ...
        {
            temp=new Byte(sNew.value[i]);
           ((NativeByteString)result).value[i] = ((Byte)temp).byteValue();
...
*/        return (NativeByteString)result;
    ...
    private NativeByteString jsFunction_concat(Context cx, Scriptable scope,Object[] args)
    {
        ...
        s1=(NativeByteString)(args[0]);
        scope = getTopLevelScope(scope);
        Scriptable result = ScriptRuntime.newObject(cx, scope, "ByteString", null);            ((NativeByteString)result).value = new byte[this.length];
    ...
    private Boolean js_equals(Context cx, Scriptable scope,Object[] args)
    {
        ...
        if(this.length!=s1.length)
                        {  Boolean result=new Boolean(false);  return result; }
        //check value
        byte para1,para2;
        for(int i=0;i<this.length;i++)
        {
    ...
    private NativeByteString jsFunction_getL(Context cx, Scriptable scope,Object[] args)
    {
        ...
        byte encoding = args.length >= 1
            ? (byte)((Number)args[0]).byteValue()
            : 0;
    ...
    private NativeByteString jsFunction_left(Context cx, Scriptable scope,Object[] args)
    {
        ...
        if(p1<0)
            throw new EvaluatorException( ( new GPError(getClassName(),GPError.INVALID_DATA)).toString());
        if(p1>this.length) p1=this.length;
    ...
    private NativeByteString jsFunction_toBase64(Context cx, Scriptable scope,Object[] args)
    {
        if(args.length==1)
            ...
            throw new EvaluatorException( ( new GPError(getClassName(),GPError.INVALID_TYPE)).toString());
        boolean lineBreak = args.length >= 1
    ...
    private NativeByteString jsFunction_toBcd(Context cx, Scriptable scope,Object[] args)
    {
        ...
        if(strBcd.length()%2!=0) strBcd="0"+strBcd;
        if(strBcd.length()<2*p1)
              while(strBcd.length()<2*p1)  strBcd="00"+strBcd; //countByte is large
        Integer ee=new Integer(GPConstant.HEX);
    ...
    /**
     * ByteString toSigned()
     * ByteString toSigned(boolean littleEndian)
     * @return
     */
    ...
    /**
     * ByteString toUnsigned()
     * ByteString toUnsigned(boolean littleEndian)
    ...
    protected int findPrototypeId(String s)
      {
          int id=0;
          String X = null;
          if (s.equals("or")) { X="or";id=Id_or; }
          if (s.equals("and")) { X="and";id=Id_and; }
          if (s.equals("xor")) { X="xor";id=Id_xor; }
          if (s.equals("crc")) { X="crc";id=Id_crc; }
          if (s.equals("neg")) { X="neg";id=Id_neg; }
          if (s.equals("not")) { X="not";id=Id_not; }
          if (s.equals("pad")) { X="pad";id=Id_pad; }
          if (s.equals("find")) { X="find";id=Id_find; }
          if (s.equals("getL")) { X="getL";id=Id_getL; }
          if (s.equals("left")) { X="left";id=Id_left; }
          if (s.equals("bytes")) { X="bytes";id=Id_bytes; }
          if (s.equals("getLV")) { X="getLV";id=Id_getLV; }
          if (s.equals("right")) { X="right";id=Id_right; }
          if (s.equals("toHex")) { X="toHex";id=Id_toHex; }
          if (s.equals("toBcd")) { X="toBcd";id=Id_toBcd; }
          if (s.equals("concat")) { X="concat";id=Id_concat; }
          if (s.equals("equals")) { X="equals";id=Id_equals; }
          if (s.equals("toString")) {X="toString";id=Id_toString; }
          if (s.equals("toSigned")) { X="toSigned";id=Id_toSigned; }
          if (s.equals("toBase64")) { X="toBase64";id=Id_toBase64; }
          if (s.equals("startsWith")) { X="startsWith";id=Id_startsWith; }
          if (s.equals("toUnsigned")) { X="toUnsigned";id=Id_toUnsigned; }
          if (s.equals("constructor")) {X="constructor";id=Id_constructor;}
          if (s.equals("hex2String")) {X="hex2String";id=Id_hex2String;}
          if (s.equals("deleteEightZero")) {X="deleteEight";id=Id_deleteEightZero;}
    ...
    private static final int
        ...
        Id_and		     	     =  MAX_INSTANCE_ID+3,
        Id_bytes	     	     =  MAX_INSTANCE_ID+4,
        Id_concat	     	     =  MAX_INSTANCE_ID+5,
        Id_crc		     	     =  MAX_INSTANCE_ID+6,
        Id_equals	     	     =  MAX_INSTANCE_ID+7,
        Id_find	     	 	     =  MAX_INSTANCE_ID+8,
        Id_getL	     		     =  MAX_INSTANCE_ID+9,
        Id_getLV	     	     =  MAX_INSTANCE_ID+10,
        Id_left		     	     =  MAX_INSTANCE_ID+11,
        Id_neg		     	     =  MAX_INSTANCE_ID+12,
        Id_not	     		     =  MAX_INSTANCE_ID+13,
        Id_or		     	     =  MAX_INSTANCE_ID+14,
        Id_pad		     	     =  MAX_INSTANCE_ID+15,
        Id_right	     	     =  MAX_INSTANCE_ID+16,
        Id_startsWith	     	     =  MAX_INSTANCE_ID+17,
        Id_toBase64	     	     =  MAX_INSTANCE_ID+18,
        Id_toBcd	     	     =  MAX_INSTANCE_ID+19,
        Id_toHex	     	     =  MAX_INSTANCE_ID+20,
        Id_toSigned	     	     =  MAX_INSTANCE_ID+21,
        Id_toUnsigned	     	     =  MAX_INSTANCE_ID+22,
        Id_xor		     	     =  MAX_INSTANCE_ID+23,
        Id_hex2String		     =  MAX_INSTANCE_ID+24,
        Id_deleteEightZero	     =  MAX_INSTANCE_ID+25,


        MAX_PROTOTYPE_ID             =  MAX_INSTANCE_ID+25;

    private static final int
        ConstructorId_fromCharCode   =  MAX_PROTOTYPE_ID + 1;
