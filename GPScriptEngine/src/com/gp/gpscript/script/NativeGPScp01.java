 ...
 * <p>Title: GPScp01</p>
 * <p>Description:
 * This class implements the GPScp01 (a built-in object).
 * See [GP_SYS_SCR] 7.1.8 </p>
...
public class NativeGPScp01 extends IdScriptableObject
{
    ...
    public static void init(Context cx, Scriptable scope, boolean sealed)
    {
        ...
        if (sealed) { prototypeGPScp01.sealObject(); }
    ...
    public String getClassName() { return "GPScp01"; }
...
/*        try
        ...
        {
            throw new EvaluatorException ( ( new GPError("GPScp01", 0, 0, e.getMessage())).toString());
        }
*/
      //encrypt
        byte[] out1=null;
