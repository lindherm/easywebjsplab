 ...
 * <p>Title: GPSystem</p>
 * <p>Description:
 * This class implements the GPSystem (a built-in object).
 * See [GP_SYS_SCR] 7.1.3 </p>
...
{private Logger log = Logger.getLogger(NativeGPSystem.class);
  ...
  public static void init(Context cx, Scriptable scope, boolean sealed)
  {
      ...
      ScriptableObject.defineProperty(scope, "GPSystem", obj,
                                      ScriptableObject.DONTENUM);
  }

    public String getClassName() { return "GPSystem"; }
    ...
    /**
     * getVendorObject
     * @param args name of the object to retrive
     * @return
     */
    private Object jsFunction_getVendorObject(Context cx, Scriptable scope,Object[] args)
    {
        ...
        {
          return null;
/*            NativeGPSupport ss=new NativeGPSupport();
            return ss.newGPSupport(cx,scope);
...
//        AddMessageThread.addMsg("Now waitting.....");
    ...
    protected void initPrototypeId(int id)
    {
            ...
            int arity;
            switch (id) {
              case Id_wait: arity = 1; name = "wait"; break;
              case Id_trace:      arity = 1; name = "trace";      break;
              case Id_getVersion:     arity = 0; name = "getVersion";     break;
              case Id_getSystemID:     arity = 0; name = "getSystemID";     break;
              case Id_getVendorObject:     arity = 1; name = "getVendorObject";     break;
              case Id_dateTimeByteString:    arity = 0; name = "dateTimeByteString";    break;
...
// #string_id_map#
    ...
    protected int findPrototypeId(String s)
    {
      int id=0;
      String X = null;
      if(s.equals("wait")) {X="wait";id=Id_wait;}
      if(s.equals("trace")) {X="trace";id=Id_trace;}
      if(s.equals("getVersion")) {X="getVersion";id=Id_getVersion;}
      if(s.equals("getSystemID")) {X="getSystemID";id=Id_getSystemID; }
      if(s.equals("getVendorObject")) {X="getVendorObject";id=Id_getVendorObject; }
      if(s.equals("dateTimeByteString")) {X="dateTimeByteString";id=Id_dateTimeByteString; }
      return id;
    }

    //define value for all function and constant
    private static final int
        Id_dateTimeByteString	=	1,
        Id_getSystemID	=  2,
        Id_getVendorObject=3,
        Id_getVersion  =   4,
        Id_trace       =   5,
        Id_wait        =   6,
        LAST_METHOD_ID  = 6,
