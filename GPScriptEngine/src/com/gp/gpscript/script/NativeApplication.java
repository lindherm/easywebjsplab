 ...
 * <p>Description:
 * This class implements the Application (a built-in object).
 * See [GP_SYS_SCR] 7.1.4
 * This class should be created before executing script.
 * when ApplicationInfo Type="OTHER"
...
public class NativeApplication extends IdScriptableObject
{
    ...
    public static void init(Context cx, Scriptable scope, boolean sealed)
    {
        ...
        if (sealed) { prototypeApplication.sealObject(); }
    }
...
//        setParentScope(prototypeApplication.getParentScope());
    ...
    private Number jsFunction_openSecureChannel(Context cx, Scriptable scope,Object[] args)
    {
        ...
        if( wrapFunction == null && this.profile.SecureChannel.Wrap != null) // compile function first time.
        {
          ...
          strWrap.append("}\r\n");
          wrapFunction = cx.compileFunction(scope, strWrap.toString(),
                                            "SecureChannelWrap", 1, null);
        }
...
/*        String fileName=GP_Global.scriptDir+GP_Global.openSecureChannelScriptFile;
        ...
        try
        {
            String ecureChannelScript="";
            ecureChannelScript=ecureChannelScript+"level="+strLevel+";";
            ecureChannelScript=ecureChannelScript+this.profile.SecureChannel.OpenSecureChannel.Script.Script;
            DataOutputStream out=new DataOutputStream(new FileOutputStream(fileName));
            out.writeBytes(ecureChannelScript);
            out.close();
        }
        catch(Exception e)
        {
            ...
            throw new EvaluatorException( (new GPError("Application", 0, 0, "create openSecure Script error")).toString());
        }
        //execute the script
        try
        {
...
*/
   ...
   public NativeByteString WrapApdu(Context cx, Scriptable scope,Number p1,Number p2,Number p3,Number p4,NativeByteString p5,Number p6,Number p7)
   {
    ...
    private static final int
        ...
        Id_profile      =   5,
        Id_secureChannel      =   6,
        MAX_INSTANCE_ID = LAST_METHOD_ID+6;
