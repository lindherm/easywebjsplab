...
{
/**
Name of the key. The key object created
in the GP Scripting language
[GP_SYS_SCR] corresponds to this
case-sensitive name. Should be uniquely
named across all Keys for the Application
Profile As such, the name of the key
should not contain any whitespace and
should be a valid variable name in
ECMAScript.
Example: KEK
*/
public		String Name;
/**
Unique ID of the Key Profile that this key
is controlled by.
*/
