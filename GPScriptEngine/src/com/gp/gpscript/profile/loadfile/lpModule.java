...
/**
Unique identifier for the module, consisting of
Application Developer��s OID + 5 bytes of
unique data. Even if the Load File Profile
has been changed, the ModuleID should not
change unless the module has been updated
by the Application Developer for the load file.
*/
public		String ModuleID;
/**
GP standard naming for the application ID
