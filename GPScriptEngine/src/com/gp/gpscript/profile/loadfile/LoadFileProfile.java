...
/**
Variable length Application Provider OID (up
to 119 bytes) + 5 byte value assigned by
Application Provider. This unique id field
must be unique amongst all UniqueID
attributes for the LoadFile element for all
Application Profiles supplied by the
Application Provider who has been assigned
the OID used.
Once the Load File Profile has been altered,
the UniqueID changes to reflect the actor
which has changed it. As well, an additional
revision element is created to enable
tracking of the modification.
Example: 00010203040506070809
Where 0001020304 is the OID of the
Application Provider.
*/
public	String UniqueID;
/**
Version of the specification the Load File
Profile adheres to, conforming to GP
