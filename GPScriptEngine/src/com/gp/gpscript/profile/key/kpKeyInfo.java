...
/**
Start date for the Key Profile in the format
YYYYMMDD.
*/
public	String StartDate;
/**
End date for the Key Profile in the format
YYYYMMDD.
*/
...
{	super(node);
		if(node.hasAttributes())
		{
			...
			if(attr!=null)Size=attr.getNodeValue();

			attr=map.getNamedItem("Exponent");
			if(attr!=null)Exponent=attr.getNodeValue();
			...
			if(attr!=null)StartDate=attr.getNodeValue();

			attr=map.getNamedItem("EndDate");
			if(attr!=null)EndDate=attr.getNodeValue();
