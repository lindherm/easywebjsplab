...
{	private Element currElement=null;
	/**
		default construct,
		the element node not be initialized,
		request user call setElement to initialize inside Element node of ProfileNode
	*/
	public ProfileNode()
	{
	}
...
/**
	get Element node value,if element node has a TEXT_NODE child node,
	return the child node value, or return null
...
/**
	if node has child node and the child node type is TEXT_NODE ,
	replace the value of child node
