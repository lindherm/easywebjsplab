...
import com.gp.gpscript.keymgr.crypto.encodings.OAEPEncoding;
import com.gp.gpscript.keymgr.crypto.encodings.PKCS1Encoding;
...
public class RSATest
    implements Test
{private static Logger log = Logger.getLogger(RSATest.class);
