...
import com.gp.gpscript.keymgr.crypto.encodings.*;
...
public class OAEPTest
    implements Test
{private static Logger log = Logger.getLogger(OAEPTest.class);
        ...
        implements Test
    {
        ...
        public TestResult perform()
        {
            ...
            try
            {
                pubStruct = new RSAPublicKeyStructure((DERConstructedSequence)new SubjectPublicKeyInfo((DERConstructedSequence)dIn.readObject()).getPublicKey());
            }
            catch (Exception e)
            {
                e.printStackTrace();
            ...
            try
            {
                privStruct = new RSAPrivateKeyStructure((DERConstructedSequence)(new PrivateKeyInfo((DERConstructedSequence)dIn.readObject()).getPrivateKey()));
            }
            catch (Exception e)
            {
                e.printStackTrace();
