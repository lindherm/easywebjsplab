package com.gp.gpscript.keymgr.util.encoders.test;
...
public class EncoderTest implements Test {
	private static Logger log = Logger.getLogger(EncoderTest.class);
	/*
	 *
	 *  VARIABLES
	 *
    ...
    public static void main(String[] _args)
    {
        ...
        log.debug(_test.testBase64());
        log.debug(_test.testHex());
    }
