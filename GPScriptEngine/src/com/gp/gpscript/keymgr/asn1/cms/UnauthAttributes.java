...
public class UnauthAttributes extends CMSObject {
	...
	public UnauthAttributes(ASN1Set _attributes) {
    ...
    /**
     * return an UnauthAttributes object from a tagged object.
     *
     ...
     */
	public static UnauthAttributes getInstance(ASN1TaggedObject _ato, boolean _explicit) {
		return getInstance(ASN1Set.getInstance(_ato, _explicit));
	}

    /**
     * return an UnauthAttributes object from the given object.
     *
     * @param _obj the object we want converted.
     * @exception IllegalArgumentException if the object cannot be converted.
     */
	public static UnauthAttributes getInstance(Object _obj) {
		if(_obj == null || _obj instanceof UnauthAttributes) {
			return (UnauthAttributes)_obj;
		}

		if(_obj instanceof Vector) {
			return new UnauthAttributes((Vector)_obj);
		}

		if(_obj instanceof ASN1Set) {
			return new UnauthAttributes((ASN1Set)_obj);
		}

		throw new IllegalArgumentException("Invalid UnauthAttributes: " + _obj.getClass().getName());
	}
