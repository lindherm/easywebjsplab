...
import com.gp.gpscript.keymgr.crypto.agreement.DHAgreement;
import com.gp.gpscript.keymgr.crypto.agreement.DHBasicAgreement;
import com.gp.gpscript.keymgr.crypto.generators.DHBasicKeyPairGenerator;
import com.gp.gpscript.keymgr.crypto.generators.DHKeyPairGenerator;
import com.gp.gpscript.keymgr.crypto.generators.DHParametersGenerator;
...
public class DHTest
    implements Test
{private static Logger log = Logger.getLogger(DHTest.class);
