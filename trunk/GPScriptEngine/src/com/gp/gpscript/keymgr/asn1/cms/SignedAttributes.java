...
public class SignedAttributes extends CMSObject {
	...
	public SignedAttributes(ASN1Set _attributes) {
    ...
    /**
     * return a SignedAttributes object from a tagged object.
     *
     ...
     */
	public static SignedAttributes getInstance(ASN1TaggedObject _ato, boolean _explicit) {
		return getInstance(ASN1Set.getInstance(_ato, _explicit));
	}

    /**
     * return a SignedAttributes object from the given object.
     *
     * @param _obj the object we want converted.
     * @exception IllegalArgumentException if the object cannot be converted.
     */
	public static SignedAttributes getInstance(Object _obj) {
		if(_obj == null || _obj instanceof SignedAttributes) {
			return (SignedAttributes)_obj;
		}

		if(_obj instanceof Vector) {
			return new SignedAttributes((Vector)_obj);
		}

		if(_obj instanceof ASN1Set) {
			return new SignedAttributes((ASN1Set)_obj);
		}

		throw new IllegalArgumentException("Invalid SignedAttributes: " + _obj.getClass().getName());
	}
