 ...
 * </p>
 * <p>
 * Description: This class implements the TLV (a native object). See [GP_SYS_SCR] 7.2.4
 * </p>
 * <p>
...
public class NativeTLV extends IdScriptableObject {
	...
	protected void fillConstructorProperties(IdFunctionObject ctor) {
		...
		ctor.defineProperty("EMV", ScriptRuntime.wrapNumber(EMV), attr);
		ctor.defineProperty("DGI", ScriptRuntime.wrapNumber(DGI), attr);
		ctor.defineProperty("L16", ScriptRuntime.wrapNumber(L16), attr);
	}
	...
	private static final int Id_encodingMode = 1, Id_size = 2, MAX_INSTANCE_ID = 2;

	private static final int Id_constructor = MAX_INSTANCE_ID + 1, Id_toString = MAX_INSTANCE_ID + 2, Id_getL = MAX_INSTANCE_ID + 3, Id_getLV = MAX_INSTANCE_ID + 4, Id_getTag = MAX_INSTANCE_ID + 5, Id_getTLV = MAX_INSTANCE_ID + 6, Id_getTV = MAX_INSTANCE_ID + 7, Id_getValue = MAX_INSTANCE_ID + 8, MAX_PROTOTYPE_ID = MAX_INSTANCE_ID + 8;
