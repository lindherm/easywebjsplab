...
/**
Specifies the memory resources originally present, prior to the loading or installation of any applications, on the
smart card. If no Unit attribute is specified, it is assumed that the memory attributes are provided in bytes.
*/
...
public		String Unit;
/**
Total Read Only Memory (ROM) present on
the smart card.
Example: 0
*/
public		String ROM;
...
public		String RAM;
/**
Total EEPROM present on the smart card
Example: 384
*/
public		String EEPROM;
/**
Total Flash memory present on the smart
card.
Example: 0
*/
public		String Flash;
/**
Whether some form of garbage collection is
supported. Attribute necessary only if some
form of garbage collection is required.
Default is false if no attribute is provided.
Example: true
*/
public		String GarbageCollection;
	...
	{	super(node);
		if(node.hasAttributes())
		{
			...
			if(attr!=null)ROM=attr.getNodeValue();
			...
			if(attr!=null)GarbageCollection=attr.getNodeValue();
