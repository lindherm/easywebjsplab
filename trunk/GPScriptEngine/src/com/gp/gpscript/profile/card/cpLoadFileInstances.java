...
/**
The LoadFileInstances element is a placeholder for individual LoadFileInstance elements. The LoadFileInstance
elements contain the detail for each of the load file instances installed.
*/
