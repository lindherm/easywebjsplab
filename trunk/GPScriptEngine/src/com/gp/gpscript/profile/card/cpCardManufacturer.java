...
/**
CardManufacturer elements are used to provide information, including PlasticStockID, from the Card
Manufacturer.
*/
...
*/
 public	 String Name;
/**
Manufacturer specific stock ID from which the
specified card product is made from.
Example: StockID123456
*/
 public	 String PlasticStockID;
  ...
  {	super(node);
 	...
 	{	Node attr;
		...
		if(attr!=null)PlasticStockID=attr.getNodeValue();
	}
