...
public class RsaUtil {
     ...
     * @param srcInfo ��ǩ����Ϣ
     */
    public static String Sign(RSAPrivateKey key, String srcInfo) throws
        Exception {
    ...
    public static String Sign(RSAPrivateKey key, byte[] srcInfo) throws
        Exception {
        Signature sign = Signature.getInstance("SHA1withRSA");
        sign.initSign(key);
        sign.update(srcInfo);
     ...
     * @param signInfo ǩ��
     */
    public static boolean VSign(RSAPublicKey key, String srcInfo,
                                String signInfo) throws Exception {
   ...
   public static void RWobject(String filename, Object obj) throws Exception {
       java.io.FileOutputStream outfile = new java.io.FileOutputStream(
           filename);
