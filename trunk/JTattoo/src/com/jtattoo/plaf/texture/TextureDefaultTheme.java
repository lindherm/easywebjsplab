...
public class TextureDefaultTheme extends AbstractTheme {
    ...
    public void setUpColor() {
        ...
        disabledForegroundColor = new ColorUIResource(102, 84, 72);
        ...
        windowTitleBackgroundColor = new ColorUIResource(200, 215, 240); //darkGray;
        ...
        windowInactiveTitleBackgroundColor = new ColorUIResource(242, 232, 220);//black;
