...
public class NoireDefaultTheme extends AbstractTheme {
    ...
    public void setUpColorArrs() {
        ...
        topColors = ColorHelper.createColorArr(topHi, topLo, 12);
        bottomColors = ColorHelper.createColorArr(bottomHi, bottomLo, 12);
        DEFAULT_COLORS = new Color[24];
        for (int i = 0; i < 12; i++) {
            DEFAULT_COLORS[i] = topColors[i];
            DEFAULT_COLORS[i + 12] = bottomColors[i];
        }
        ...
        for (int i = 0; i < 12; i++) {
            ...
            ROLLOVER_COLORS[i + 12] = bottomColors[i];
        }
