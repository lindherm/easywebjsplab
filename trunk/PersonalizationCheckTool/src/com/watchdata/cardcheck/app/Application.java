...
public class Application extends JFrame {
	...
	public void updateLookAndFeel(String lf) {
		/*try {
			...
			if (oldLAF instanceof AbstractLookAndFeel) {
				oldDecorated = AbstractLookAndFeel.getTheme()
						.isWindowDecorationOn();
			}

			// reset to default theme
			if (lf.equals(GUIProperties.PLAF_FAST)) {
			 ...
			 * com.jtattoo.plaf.
			 * custom.systemx.SystemXLookAndFeel.setTheme("Default"); }
			...
			if (newLAF instanceof AbstractLookAndFeel) {
				newDecorated = AbstractLookAndFeel.getTheme()
						.isWindowDecorationOn();
			}
			...
			log.info("LookAndFeel unsupported, update LookAndFeel fail.");
		}*/
	...
	/*
	 * public void setMainTabbedPane(JTabbedPane tabPane) { mainTabbedPane =
	 * tabPane; }
	 */

	public static void initGlobalFontSetting(String fontName, int style,
			int size) {
