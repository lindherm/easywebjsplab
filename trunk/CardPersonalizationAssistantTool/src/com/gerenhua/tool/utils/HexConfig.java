...
public class HexConfig {
	...
	public HexConfig(String filePath){
	...
	public static void main(String[] args) {
		Collection<String>items=HexConfig.getItems("FILE_TYPE");
		for (String string : items) {
			System.out.print(string+"\t");
			System.out.println(HexConfig.getValue("FILE_TYPE", string));
		}
		
		HexConfig.setValue("hello", "name", " 中国人最好 ");
		System.out.println(HexConfig.getValue("hello","name"));
	}
}
