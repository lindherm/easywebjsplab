...
public class TLV {
	...
	public static final byte DGI2 = 4;
	 ...
	 * 
	 * @param tag
	 *            The Tag that will be assigned to the TLV.
	 * @param value
	 *            The Value data that will be assigned to the TLV.
	 * @param encoding
	 *            Value representint the encodeing method
	...
	public static void main(String[] args) {
		String a = "864B0101487046572844B3E2DDC7E153E979BD37CF2ECF72EDB351948789AA282B252B398C26125E2E8084D6609EB554235F200200009F6110DE8D55142B18DEB74AF8724232CB4AE49F620100";
		TLV MyTLV = new TLV(0x0202, WDByteUtil.HEX2Bytes(a), EMV);
		System.out.println(MyTLV.getTag());

		System.err.println(WDByteUtil.bytes2HEX(MyTLV.getTLV()));

		/*
		 * String testVec = "313133313133313133313133"; byte[] value = Hex.decode(testVec);
		 * 
		 * byte[] value2B = new byte[200];
		 * 
		 * for(int i=0;i<200;i++) value2B[i] =(byte)i;
		 * 
		 * 
		 * log.debug("parse Parameters,should be -4"); log.debug(parseParameters(0x0314,value,EMV));
		 * 
		 * log.debug("parse Parameters,should be OK"); log.debug(parseParameters(0x0314,value,DGI));
		 * 
		 * log.debug("parse Parameters,should be OK"); log.debug(parseParameters(0x9f14,value,EMV));
		 * 
		 * log.debug("parse Parameters,should be -4"); log.debug(parseParameters(0x59f14,value,EMV));
		 * 
		 * log.debug("parse Parameters,should be -2"); log.debug(parseParameters(0x9f14,null,EMV));
		 * 
		 * 
		 * 
		 * 
		 * TLV MyTLV = new TLV(0x03,value,EMV); log.debug("0x03  L LV Tag TLV TV Value"); log.debug(new String(Hex.encode(MyTLV.getL()))); log.debug(new String(Hex.encode(MyTLV.getLV()))); log.debug(MyTLV.getTag() ); log.debug(new String(Hex.encode(MyTLV.getTLV()))); log.debug(new String(Hex.encode(MyTLV.getTV()))); log.debug(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * MyTLV = new TLV(0x9f03,value,EMV); log.debug("0x9f03 L LV Tag TLV TV Value"); log.debug(new String(Hex.encode(MyTLV.getL()))); log.debug(new String(Hex.encode(MyTLV.getLV()))); log.debug(MyTLV.getTag() ); log.debug(new String(Hex.encode(MyTLV.getTLV()))); log.debug(new String(Hex.encode(MyTLV.getTV()))); log.debug(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * MyTLV = new TLV(0x03,value2B,EMV); log.debug("0x03 L LV Tag TLV TV Value"); log.debug(new String(Hex.encode(MyTLV.getL()))); log.debug(new String(Hex.encode(MyTLV.getLV()))); log.debug(MyTLV.getTag() ); log.debug(new String(Hex.encode(MyTLV.getTLV()))); log.debug(new String(Hex.encode(MyTLV.getTV()))); log.debug(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * MyTLV = new TLV(0x9f03,value2B,EMV); log.debug("0x9f03 L LV Tag TLV TV Value"); log.debug(new String(Hex.encode(MyTLV.getL()))); log.debug(new String(Hex.encode(MyTLV.getLV()))); log.debug(MyTLV.getTag() ); log.debug(new String(Hex.encode(MyTLV.getTLV()))); log.debug(new String(Hex.encode(MyTLV.getTV()))); log.debug(new String(Hex.encode(MyTLV.getValue())));
		 */

		/*
		 * System.out.println("0x03"); MyTLV = new TLV(0x03,value,DGI); System.out.println(new String(Hex.encode(MyTLV.getL()))); System.out.println(new String(Hex.encode(MyTLV.getLV()))); System.out.println(MyTLV.getTag() ); System.out.println(new String(Hex.encode(MyTLV.getTLV()))); System.out.println(new String(Hex.encode(MyTLV.getTV()))); System.out.println(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * System.out.println("0x0043"); MyTLV = new TLV(0x0043,value,DGI); System.out.println(new String(Hex.encode(MyTLV.getL()))); System.out.println(new String(Hex.encode(MyTLV.getLV()))); System.out.println(MyTLV.getTag() ); System.out.println(new String(Hex.encode(MyTLV.getTLV()))); System.out.println(new String(Hex.encode(MyTLV.getTV()))); System.out.println(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * System.out.println("0x0143"); MyTLV = new TLV(0x0143,value,DGI); System.out.println(new String(Hex.encode(MyTLV.getL()))); System.out.println(new String(Hex.encode(MyTLV.getLV()))); System.out.println(MyTLV.getTag() ); System.out.println(new String(Hex.encode(MyTLV.getTLV()))); System.out.println(new String(Hex.encode(MyTLV.getTV()))); System.out.println(new String(Hex.encode(MyTLV.getValue())));
		 * 
		 * System.out.println("0x1143"); MyTLV = new TLV(0x1443,value,DGI); System.out.println(new String(Hex.encode(MyTLV.getL()))); System.out.println(new String(Hex.encode(MyTLV.getLV()))); System.out.println(MyTLV.getTag() ); System.out.println(new String(Hex.encode(MyTLV.getTLV()))); System.out.println(new String(Hex.encode(MyTLV.getTV()))); System.out.println(new String(Hex.encode(MyTLV.getValue())));
		 */
	}
