...
public class QuickFindDialog extends javax.swing.JDialog implements DocumentListener, ActionListener, EscapeListener {
	...
	public void showFor(final JTextComponent target) {
		...
		Point loc = new Point(0, view.getHeight()/3);
		setSize(wd);
	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 684, Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jToolBar1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE));
	...
	private void updateFind() {
		...
		try {
			...
			d.setPattern(toFind, jChkRegExp.isSelected(), jChkIgnoreCase.isSelected());
