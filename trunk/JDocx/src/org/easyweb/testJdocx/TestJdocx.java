...
import org.easyweb.jdocx.TestDemo;

public class TestJdocx {
	...
	public String replaceRTF(String content, String replacecontent, int flag) {
		...
		if (flag == 0) {
			...
			target = content.replace(strToRtf("$位置$"), rc);
	...
	public static void main(String[] args) {
		//System.out.println(new TestJdocx().strToRtf("卧室2012 年月日3月"));
		// TODO Auto-generated method stub

		TestJdocx oRTF = new TestJdocx();
