...
public class TradePanel extends JImagePanel {
	...
	public static ImageIcon img = new ImageIcon(proPath + "/images/trade.png");
	ImageIcon qPBOCIcon = new ImageIcon(proPath + "/images/qPBOC.png");
	ImageIcon lendIcon = new ImageIcon(proPath + "/images/lend.png");
	ImageIcon earmarkIcon = new ImageIcon(proPath + "/images/earmark.png");
	ImageIcon ecashIcon = new ImageIcon(proPath + "/images/ecash.png");
	ImageIcon okIcon = new ImageIcon(proPath + "/images/OK.png");
	ImageIcon cancelIcon = new ImageIcon(proPath + "/images/cancel.png");
	ImageIcon zeroIcon = new ImageIcon(proPath + "/images/0.png");
	ImageIcon oneIcon = new ImageIcon(proPath + "/images/1.png");
	ImageIcon twoIcon = new ImageIcon(proPath + "/images/2.png");
	ImageIcon threeIcon = new ImageIcon(proPath + "/images/3.png");
	ImageIcon fourIcon = new ImageIcon(proPath + "/images/4.png");
	ImageIcon fiveIcon = new ImageIcon(proPath + "/images/5.png");
	ImageIcon sixIcon = new ImageIcon(proPath + "/images/6.png");
	ImageIcon sevenIcon = new ImageIcon(proPath + "/images/7.png");
	ImageIcon eightIcon = new ImageIcon(proPath + "/images/8.png");
	ImageIcon nineIcon = new ImageIcon(proPath + "/images/9.png");
	ImageIcon dotIcon = new ImageIcon(proPath + "/images/dot.png");
	ImageIcon backIcon = new ImageIcon(proPath + "/images/back.png");
